...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
      <div class="container">
        <a class="navbar-brand text-dark" href="#">Gentokki</a>
        <button
    ...
    <section
      id="hero"
      class="isi text-center p-5 bg-danger-subtle text-sm-start text-dark"
    >
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="img/1.png" class="img-fluid" width="320" />
          <div>
            <h1 class="fw-bold dispaly-4">
              Gintama Gintoki Sakata, seorang samurai yang bekerja sebagai
              freelancer bersama teman-temannya Shinpachi Shimura dan Kagura.
            </h1>
            <h4 class="lead dispaly-6">
              Orang tua perlu tahu bahwa Gintama adalah serial anime komedi yang
              berdasarkan pada serial manga Gin Tama yang dibuat oleh Hideaki
              Sorachi. Serial ini berpusat di sekitar Gintoki, seorang samurai
              yang menjalankan bisnis pekerjaan sambilan bersama teman-temannya.
            </h4>
            <h6>
...
<!-- Gallery End -->
    ...
    <section
      id="aboutme"
      class="isi text-center mt-5 p-5 bg-danger-subtle text-sm-start text-dark"
      href="#aboutme"
    >
      <div class="container">
        <h1 class="fw-bold dispaly-4 pb-3 text-center">ABout Me</h1>
        <div class="me-5 ms-5 d-sm-flex flex-sm-row align-items-center">
          <img src="https://www.wowkeren.com/images/photo/cristiano_ronaldo.jpg" class="img-fluid rounded-circle me-4" width="280" />
          <div>
            <h4 class="lead dispaly-6 mt-5">
              A11.2023.15301
            </h4>
            <h1 class="fw-bold dispaly-4">
              Muhammad Fabian Rizky Fatah
            </h1>
            <h4 class="lead dispaly-6">
    ...
    <footer class="text-center p-5">
      <div>
        <a href="https://www.instagram.com/fabian68888/"
          ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://x.com/louisabdulkadir"
          ><i class="bi bi-twitter-x h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/6285225690226"
          ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
      </div>
      <div>Muhammad Fabian Rizky Fatah&copy; 2024</div>
    </footer>
    <!-- footer end -->
